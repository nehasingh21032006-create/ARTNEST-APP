    ...
    <div className="h-screen w-full bg-[#FDF1E8] flex items-center justify-center p-3 sm:p-6 overflow-hidden">
      <div className="w-full max-w-5xl max-h-[94vh] grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="bg-white rounded-2xl shadow-[0_2px_24px_rgba(80,40,20,0.06)] p-5 sm:p-7 overflow-y-auto max-h-[94vh]"
        >
          ...
          <motion.p variants={item} className="text-[13px] text-stone-500 mb-5 max-w-sm">
            Discover and collect original art, handcrafted sculptures, and bespoke works from independent artists worldwide.
          </motion.p>
          ...
          <motion.div variants={item} className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-3">
            ...
            <div className="flex-1">
              <label className="block text-[12px] font-medium text-stone-700 mb-1">Confirm Password</label>
              <div className="relative">
                <input
          ...
          <motion.label variants={item} className="flex items-start gap-2 mb-2.5 cursor-pointer select-none">
            <input
              type="checkbox"
              checked={agree}
            ...
            <span className="text-[12px] text-stone-600">
              I agree to the{" "}
              <a href="#" className="text-[#A5522F] underline underline-offset-2">Terms of Service</a> and{" "}
              <a href="#" className="text-[#A5522F] underline underline-offset-2">Privacy Policy</a>
            </span>
          </motion.label>

          <motion.label variants={item} className="flex items-start gap-2 mb-5 cursor-pointer select-none">
            <input
              type="checkbox"
              checked={updates}
            ...
            />
            <span className="text-[12px] text-stone-600">
              Send me curatorial updates, featured artist spotlights, and new artwork releases (optional).
            </span>
          </motion.label>
          ...
          <motion.p variants={item} className="text-center text-[12px] text-stone-500 mt-3">
            ...
            <a href="/login/buyer" className="font-medium text-[#A5522F]">Sign In</a>
          </motion.p>
          ...
          <motion.div variants={item} className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0 mt-4 pt-4 border-t border-stone-100 text-[12px]">
            <span className="text-stone-500">Are you an artist or gallery?</span>
            <a href="/register/artist" className="font-medium text-stone-800 flex items-center gap-1">
              Apply as Artist <ArrowRight size={12} />
            </a>
          </motion.div>
        </motion.div>
        <motion.div
